...
<main class="container mx-auto mt-6 flex justify-center">
    ...
    <section class="w-3/5 bg-white p-6 shadow-md rounded-lg mb-10">
        ...
        <img class="card-img-top rounded" src="https://dummyimage.com/850x350/dee2e6/6c757d.jpg"
        alt="...">
        <p class="text-gray-600 mb-4 mt-4">Published on <span class="font-semibold">March 2, 2025</span></p>
